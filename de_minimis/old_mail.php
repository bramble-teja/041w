<?php
	...
	$getproducer=mysql_query("select * from producer tp_status=1 and ((obligation_type_b2b=1 and obligation_type_b2c =1) or (obligation_type_b2b=0 and obligation_type_b2c =1))");
	...
	{
		$mail=$prodmail['email'];
$url="http://avcweeeco.com/clients/target_pipeline/returns_mail_monthly.php?pid=$pid&y=$yid&m=$cmonth";
 $to= $mail;
